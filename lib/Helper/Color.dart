...
//   // static Color get fontColor => ISDARK == "true" ? secondary : const Color(0xff12EAFE);
//   static const Color grad1Color = Color(0xFF0e2149);
//   static const Color grad2Color = Color(0xFF0e2149);
//   // static const Color lightWhite2 = Color(0xFF12EAFE);
...
//   static const Color darkColor2 = Color(0xffFFFFFF);
//
//   static Color get white => ISDARK == "true" ? darkColor2 : const Color(0xff273152);
//   static const Color whiteTemp = Color(0xff273152);
//
//   static Color get black => ISDARK == "true" ? whiteTemp : const Color(0xff273152);
//
...
//   static const Color black12 = Colors.black;
...
class colors {
  ...
  static Color get fontColor => ISDARK == "true" ? secondary : const Color(0xFF0e2149);
  static const Color grad1Color = Color(0xff2a3faa);
  static const Color grad2Color = Color(0xFF0e2149);
  static const Color lightWhite2 = Color(0xffEEF2F3);
  static const Color shocaseBlue = Color(0xFF0e2149);
